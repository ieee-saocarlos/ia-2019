...
class Tela(pyglet.window.Window):
    def __init__(self, *args, **kwargs):
        ...
        self.cores = [r'imagens\bola_vermelha.png', r'imagens\bola_rosa.png', r'imagens\bola_amarela.png',
                      r'imagens\bola_verde.png', r'imagens\bola_azul.png']
