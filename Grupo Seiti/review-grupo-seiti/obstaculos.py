...
class Triangulo1:
    def __init__(self, x, y, a):
        ...
        self.triangulo1 = pymunk.Poly(self.triangulo1_body,
                                      ((-a, 0), (a * math.sqrt(3) / 2, -a), (a * math.sqrt(3) / 2, a)))
...
class Trigira:
    def __init__(self, x, y, l):
        self.trigira = pymunk.Poly(None, (
        (-l * math.sqrt(3) / 3, 0), (l * math.sqrt(3) / 6, -l / 2), (l * math.sqrt(3) / 6, l / 2)))
